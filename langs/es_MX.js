tinymce.addI18n("es_MX", {
    ...
    "Accordion summary...": "Resumen del acorde\xf3n...",
    Action: "Acci\xf3n",
    Activity: "Actividad",
    ...
    "Could not find the specified string.":
      "No se ha encontrado la cadena indicada.",
    ...
    "Error: Form submit field collision.":
      "Error: colisi\xf3n del campo para el env\xedo de formulario",
    "Error: No form element found.":
      "Error: no se encontr\xf3 ning\xfan elemento de formulario.",
    "Extended Latin": "Lat\xedn extendido",
    "Failed to initialize plugin: {0}":
      "Error al inicializar el complemento: {0}",
    "Failed to load plugin url: {0}":
      "Error al cargar la url del complemento: {0}",
    "Failed to load plugin: {0} from url {1}":
      "Error al cargar el complemento: {0} desde la url {1}",
    "Failed to upload image: {0}": "Error al cargar la imagen: {0}",
    File: "Archivo",
    Find: "Buscar",
    "Find (if searchreplace plugin activated)":
      "Buscar (si el complemento de buscar y reemplazar est\xe1 activado)",
    ...
    "Focus to contextual toolbar":
      "Llevar el foco a la barra de herramientas contextual",
    ...
    "ImageProxy HTTP error: Rejected request":
      "Error HTTP de ImageProxy, solicitud rechazada",
    "ImageProxy HTTP error: Unknown ImageProxy error":
      "Error de ImageProxy HTTP. Error de ImageProxy desconocido",
    ...
    "Insert link (if link plugin activated)":
      "Insertar v\xednculo (si el complemento de v\xednculos est\xe1 activado)",
    ...
    "Invalid hex color code: {0}":
      "El c\xf3digo de color hexadecimal {0} no es v\xe1lido",
    ...
    "Open popup menu for split buttons":
      "Abrir men\xfa emergente para botones divididos",
    Orange: "Anaranjado",
    Outset: "Inicial",
    ...
    "Press the Up and Down arrow keys to resize the editor.": "Presiona la teclas Arriba y Abajo para cambiar el tama\xf1o del editor",
    "Press the arrow keys to resize the editor.": "Presiona las teclas de flechas para cambiar el tama\xf1o del editor ",
    "Press {0} for help": "Presiona {0} para obtener ayuda",
    ...
    "Rich Text Area. Press ALT-0 for help.":
      "\xc1rea de texto enriquecido. Pulse ALT-0 para obtener ayuda.",
    ...
    "Switch to or from fullscreen mode":
      "Cambiar a o desde el modo de pantalla completa",
    Symbols: "S\xedmbolos",
    ...
    "To open the popup, press Shift+Enter":
      "Para abrir la ventana emergente, presione May\xfas+Intro",
    ...
    "yuan character, in hong kong and taiwan":
      "car\xe1cter del yuan, en Hong Kong y Taiw\xe1n",
